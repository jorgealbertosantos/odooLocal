...
class libro_line(models.Model):
        ...
        # compras
        internas_e = fields.Monetary(_('Internas'), store=True, currency_field='company_currency_id')
        importaciones_e = fields.Monetary(_('Importaciones'), store=True, currency_field='company_currency_id')
        internas_g = fields.Monetary(_('Internas'), store=True, currency_field='company_currency_id')
        importaciones_g = fields.Monetary(_('Importaciones'), store=True, currency_field='company_currency_id')
