...
class LibroIva(models.Model):
  ...
  fecha = fields.Date(string=_('Fecha'), 
      index=True, help=_("Fecha de realizado el informe"), copy=False, default=time.strftime('%Y-%m-%d'), track_visibility='onchange')
  ...
  mes = fields.Selection([
    ...
    ('11','Noviembre'),
    ('12','Diciembre'),
  ], string=_("Mes"), index=True, default=time.strftime("%m"), copy=False, required=True, track_visibility='onchange')
  ...
  responsable_id = fields.Many2one('res.users', _('Responsable'), required=True, readonly=True, states={'draft': [('readonly', False)]},
        help=_("Seleccione la persona que validara el libro"), track_visibility='always')
  ...
  libro_line_compras =  fields.One2many('libro.line', 'libro_iva_id', 'Lineas Libro', readonly=True)
  libro_line_ccf =  fields.One2many('libro.line', 'libro_iva_id', 'Lineas Libro', readonly=True)
  libro_line_fcf =  fields.One2many('libro.line', 'libro_iva_id', 'Lineas Libro', readonly=True)
  resumen_line_fcf =  fields.One2many('resumen.line', 'libro_iva_id', 'Lineas Resumen', readonly=True)
  resumen_line_ccf =  fields.One2many('resumen.line', 'libro_iva_id', 'Lineas Resumen', readonly=True)
  resumen_line_compras =  fields.One2many('resumen.line', 'libro_iva_id', 'Lineas Resumen', readonly=True)
