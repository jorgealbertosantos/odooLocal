...
class resumen_line(models.Model):
        ...
        #contribuyentes
        neto_p = fields.Monetary(_('Valor Neto'), store=True, currency_field='company_currency_id')
        iva_p = fields.Monetary(_('Debito Fiscal'), store=True, currency_field='company_currency_id')
        neto_t = fields.Monetary(_('Valor Neto'), store=True, currency_field='company_currency_id')
        iva_t = fields.Monetary(_('Debito Fiscal'), store=True, currency_field='company_currency_id')
